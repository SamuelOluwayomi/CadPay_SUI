                        ...
                        return (
                            <a
                                ...
                                className={cn(
                                    ...
                                    isActive
                                        ? "text-foreground bg-white/5 border-2 border-primary shadow-[0_0_12px_rgba(249,115,22,0.4)]"
                                        : "text-muted-foreground hover:text-foreground hover:bg-white/8 border-2 border-transparent",
                                )}
                            >
                        ...
                        return (
                            <a
                                ...
                                className={cn(
                                    ...
                                    isActive
                                        ? "text-foreground bg-white/5 font-semibold border-2 border-primary"
                                        : "text-muted-foreground hover:text-foreground hover:bg-white/8 border-2 border-transparent",
                                )}
                            >
